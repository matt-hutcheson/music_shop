...
public class Keyboard extends Keys {
    public Keyboard(InstrumentType instrumentType, Material material, Colour colour, boolean requiresCase, double buyingPrice, double sellingPrice, KeyType keysType, int noOfKeys, boolean electric){
        super(instrumentType,material,colour,requiresCase,buyingPrice,sellingPrice,keysType,noOfKeys,electric);
    }

    public String play(){
        return "Electronic plonking";
    }
}
